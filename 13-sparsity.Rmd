...
The following example is taken from [John Myles White's blog](http://www.johnmyleswhite.com/notebook/2011/10/31/using-sparse-matrices-in-r/).
...
for (sim in 1:10){
  ...
  sparse.times <- system.time(fit1 <- glmnet(sx, y)) # fit with sparse glmnet
  full.times <- system.time(fit2 <- glmnet(x, y)) # fit with dense glmnet

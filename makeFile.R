...
bookdown::preview_chapter('20-datatable.Rmd',"bookdown::gitbook" )
bookdown::preview_chapter('20-datatable.Rmd',"bookdown::word_document2" )
bookdown::preview_chapter('20-datatable.Rmd',"bookdown::pdf_book" )

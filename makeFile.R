...
bookdown::render_book("index.Rmd","bookdown::gitbook") # render to HTML
bookdown::render_book("index.Rmd","bookdown::word_document2") # rendoer to DOCX
bookdown::render_book("index.Rmd","bookdown::pdf_book") # rendoer to PDF
...
bookdown::preview_chapter('03-eda.Rmd',"bookdown::gitbook" )

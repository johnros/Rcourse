...
They have thus been extended in recent years with the `data.table` class in the  __data.table__ package, and `tbl` class, pronounced [Tibble] (https://cran.r-project.org/web/packages/tibble/vignettes/tibble.html). 

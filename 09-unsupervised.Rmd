...
A more principled view, when $x$ is categorical, is that of [Multiple Correspondence Analysis](https://en.wikipedia.org/wiki/Multiple_correspondence_analysis).
...
Because the length of a tree's branch is proportional to distances, long branches imply inhomogenous groups, while short branches imply homogenous groups.
Here is a little simulation to deminstrate this:

...
A lot of parallelisation still has to be explicit, but stay tuned for technologies like [Ray](https://rise.cs.berkeley.edu/projects/ray/), [Apache Spark](https://spark.apache.org), [PyTorch](https://pytorch.org), and others, which are making great advances in handling parallelism for you. 
...
Should you parallelize locally? 
Should you go cloud?
...
When deciding if, and how, to parallelise, it is thus crucial that you diagnose your bottleneck. 

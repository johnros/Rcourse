...
- [Data Parallel] When performing differest tasks on the same data. 
- [Task Parallel] When performing the same task, on different data. 
...
- Fork: a mechanism, unique to Unix and Linux, that clones a process with accompanying instructions and data. Recall that processes do not share memory. Each process updates its own copy of the data. 

- Spawn: a machanism, available under all operating systems, for a process to start an "offspring" process. It is quite similar to _fork_.

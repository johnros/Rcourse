...
This is because thinking with '<-' helps to read your code, distinguishes between assignemtns and function arguments: `function(argument=value)`, and understand things like `<<-` and `->`. 
```

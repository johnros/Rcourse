...
Let $x_i$ be the temperate at which bottle-cap $i$ was manufactured. 
...
coefs.lm1
```
We see that the p-value for $H_{0,1}: \beta_1=0$ against a two sided alternative is effectively `r round(coefs.lm1[2,4],2)`, so that $\beta_1$ is unlikely to be $0$.

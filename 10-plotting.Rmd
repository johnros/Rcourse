...
We take a non-typical approach by ignoring this function, and presenting the fundamental building blocks. 
...
As already mentioned, the recent and dramatic advancement in interactive visualization was made possible by the advances in web technologies. 
This is because it allows developers to rely on existing libraries, typically in JavaScript, designed for web browsing.
...
<!-- - Shiny -->
<!-- - plotly - of course  -->
<!-- - HTML widgets - http://www.htmlwidgets.org/showcase_highcharts.html  -->
<!--    and gallery of widgets: http://gallery.htmlwidgets.org/ -->
<!-- - dygraphs for TS - https://rstudio.github.io/dygraphs/index.html -->
<!-- - rCharts - http://rdatascience.io/rCharts/ -->
<!--   specificly the nvd3 charts - http://rdatascience.io/posts/rcharts-nvd3/ -->

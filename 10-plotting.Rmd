...
Better look at boxplots along time (even if committing the `Cow` information).
```{r}
...
__Scales__ define the actual mapping of an aesthetics values to data values.
...
- The `alpha=1/3` parameter controls the transparency. Set to `alpha=1` for opaque, and `alpha=0` for transparent.

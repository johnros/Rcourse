...
#### t-SNE
TODO.
For a natve R implementation: [tsne package](https://cran.r-project.org/web/packages/tsne/).
For an R wrapper for C libraries: [Rtsne package](https://github.com/jkrijthe/Rtsne).
The latter should be faster. Did not check.
...
For an interactive, visual demonstration of dimensionality reduction, see [Christopher Olah's](http://colah.github.io/posts/2014-10-Visualizing-MNIST/) excellent blog. 

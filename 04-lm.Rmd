...
As in any two-way ANOVA, we may want to ask if different genders respond differently to different treatments. 
...
This is because when allowing a different average response for every $Treatment*Age$ combination, we are effectively estimating $3*2=6$ 

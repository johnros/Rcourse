...
What is you are applying the same function with __two__ lists of arguments? Use __mapply__.
...
## Strings
TODO. In the meanwhile, see [Gaston Sanchez's book](http://www.gastonsanchez.com/r4strings/). 

## Dates and Times
TODO. In the meanwhile, see the [lubridate](https://lubridate.tidyverse.org/) pacakge.
Also note manipulating dates and times is different than working with time series. 
...
You can also self practice with DataCamp's [Intoroduction to R](https://www.datacamp.com/courses/free-introduction-to-r) course. 

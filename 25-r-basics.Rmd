...
Oh dear. 
`read.,table` tried to guess the structure of the input, but failed to recognize the header row. Set it manually with `header=TRUE` (file taken from [git](https://github.com/johnros/Rcourse/tree/master/data)):
```{r, eval=FALSE}

...
## Strings
TODO. 
In the meanwhile, see [Gaston Sanchez's book](http://www.gastonsanchez.com/r4strings/). 

## Dates and Times
TODO. 
In the meanwhile, see the [lubridate](https://lubridate.tidyverse.org/) pacakge.

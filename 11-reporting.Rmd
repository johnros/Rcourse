...
You can run the app via the __RunApp__ button in the RStudio interface, of by calling the app's directory with the `runApp` function.
...
- `sidebarLayout` is a wrapper for the layout, which includes a sidebar, governed by `sidebarPanel`, and a main panel, governed by `mainPanel`.

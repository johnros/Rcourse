...
A nice bivariate counterpart of the univariate histogram is the _hexbin plot_, which tessellates the 
...
<!--chapter:end:09-unsuprvised.Rmd-->


# Parallel Computing {#parallel}

<!--chapter:end:10-parallel.Rmd-->


# Memory Efficiency {#memory}

<!--chapter:end:11-memory.Rmd-->


# Sparse Representations {#sparse}

<!--chapter:end:12-sparsity.Rmd-->


# Convex Optimization {#convex}

<!--chapter:end:13-convex-optimization.Rmd-->


# RCpp {#rcpp}

<!--chapter:end:14-rcpp.Rmd-->


# Numerical Linear Algebra {#algebra}

<!--chapter:end:15-algebra.Rmd-->


# Writing Packages {#package}

<!--chapter:end:16-packaging.Rmd-->


# Plotting {#plotting}

<!--chapter:end:17-plotting.Rmd-->


# Reports {#report}

<!--chapter:end:20-reporting.Rmd-->

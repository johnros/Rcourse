...
Demonstrating our terminology on Example \@ref(exm:icu): 
...
Multivariate regression means finding the factors which many explain the departure from the healthy state. 
Fitting a distribution means finding the joint distribution of the physiological measurements, and in particular, their dependence and independence. 
...
Personally, I would never trust a Hotelling test if $n$ is not much greater than $p$...
...
For some cutting edge solutions for testing in high-dimension, see @goeman2006testing.

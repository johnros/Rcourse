...
To discuss the distribution of Hotelling's test statistic we need to introcude some vocabulary^[This vocabulary is not standard in the literature, so when you read a text, you need to verify yourself which regime the author is considering.]:
